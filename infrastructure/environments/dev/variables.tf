...
variable "ssh_key_name" {
  ...
  default     = "minitwit-dev-key"
}

variable "droplet_name" {
  type        = string
  description = "DigitalOcean name for the single-droplet module instance."
  default     = "minitwit-dev"
}

variable "droplet_file_source" {
  type        = string
  description = "Path to the file copied onto the droplet (relative to the single-droplet module directory)."
  default     = "../../../razor-pages/Dockerfile"
}