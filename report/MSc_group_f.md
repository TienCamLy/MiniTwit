...
The logs are aggregated in Grafana in two dashboards — PROD displaying data from three deployment replicas and DEV providing insight into a separate replica used to validate pull requests. All logs are visible side by side in a dedicated logging segment in the Drilldown section.
